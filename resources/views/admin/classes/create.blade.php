...
<div class="max-w-3xl mx-auto py-6">
    ...
    <div class="bg-slate-800 rounded-3xl border border-slate-700 shadow-2xl overflow-hidden">
        ...
        <!-- Static Form Body -->
        <form class="p-8 space-y-8" onsubmit="return false;">
            
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <!-- Nom Attribute -->
                <div class="space-y-2">
                    <label for="nom" class="block text-sm font-bold text-slate-300 ml-1 uppercase tracking-widest text-[11px]">Class Name (Nom)</label>
                    <input type="text" id="nom" name="nom" placeholder="e.g. Fullstack Web Dev" 
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" id="promotion" name="promotion" placeholder="e.g. 2025 - 2026" 
                        class="block w-full px-5 py-4 bg-slate-900 border border-slate-700 rounded-2xl text-white focus:ring-2 focus:ring-indigo-600 outline-none transition-all placeholder:text-slate-600">
                </div>
            </div>
            ...
            <div class="space-y-2">
                <label for="formateur_id" class="block text-sm font-bold text-slate-300 ml-1 uppercase tracking-widest text-[11px]">Assigned Trainer (Formateur)</label>
                <div class="relative">
                    <select id="formateur_id" name="formateur_id" class="block w-full px-5 py-4 bg-slate-900 border border-slate-700 rounded-2xl text-white focus:ring-2 focus:ring-indigo-600 outline-none transition-all appearance-none cursor-pointer">
                        <option value="" disabled selected>Select an instructor from the personnel list...</option>
                        <option>Amine Bell (Tech Lead)</option>
                        <option>Sarah Green (Senior Trainer)</option>
                        <option>John Wick (Backend Specialist)</option>
                    </select>
            ...
            <div class="flex items-center justify-end space-x-5 pt-6 border-t border-slate-700/50">
                <button type="button" class="px-6 py-3 text-slate-400 font-bold hover:text-white transition-colors">Discard</button>

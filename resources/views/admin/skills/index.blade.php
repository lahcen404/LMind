...
<div class="space-y-8">
    ...
    <!-- Competency Matrix (Removed Section Groupings) -->
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-slate-800 rounded-3xl border border-slate-700 overflow-hidden shadow-2xl">
            ...
            <div class="p-4 space-y-1">
                ...
                <div class="flex items-center justify-between p-4 rounded-2xl hover:bg-slate-700/30 transition group border border-transparent hover:border-slate-600">
                    <div class="flex items-center space-x-6">
                        <span class="text-xs font-black text-indigo-400 w-6">C3</span>
                        <div class="h-4 w-px bg-slate-700"></div>
                        <span class="text-sm font-bold text-slate-300 group-hover:text-white transition-colors">Développer une interface dynamique</span>
                    </div>
                    <button class="text-slate-600 group-hover:text-indigo-400 transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                    </button>
        ...
        <div class="bg-slate-800 rounded-3xl border border-slate-700 overflow-hidden shadow-2xl">
            ...
            <div class="p-4 space-y-1">
                ...
                <div class="flex items-center justify-between p-4 rounded-2xl hover:bg-slate-700/30 transition group border border-transparent hover:border-slate-600">
                    ...
                    <button class="text-slate-600 group-hover:text-purple-400 transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                    </button>
                </div>
                <!-- C5 -->
                <div class="flex items-center justify-between p-4 rounded-2xl hover:bg-slate-700/30 transition group border border-transparent hover:border-slate-600">
                    <div class="flex items-center space-x-6">
                        <span class="text-xs font-black text-purple-400 w-6">C5</span>
                        <div class="h-4 w-px bg-slate-700"></div>
                ...
                <div class="flex items-center justify-between p-4 rounded-2xl hover:bg-slate-700/30 transition group border border-transparent hover:border-slate-600">
                    <div class="flex items-center space-x-6">
                        <span class="text-xs font-black text-purple-400 w-6">C6</span>
                        <div class="h-4 w-px bg-slate-700"></div>
                        <span class="text-sm font-bold text-slate-300 group-hover:text-white transition-colors">Développer la partie back-end d'une application</span>
                    </div>
                    <button class="text-slate-600 group-hover:text-purple-400 transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                    </button>

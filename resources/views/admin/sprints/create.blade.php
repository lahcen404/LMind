...
<div class="max-w-4xl mx-auto py-4">
    ...
    <a href="/sprints" class="inline-flex items-center text-indigo-400 hover:text-indigo-300 font-bold text-xs mb-8 transition group">
        ...
        <div class="p-8 border-b border-slate-700 bg-slate-800/50">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-slate-400 text-sm font-medium mt-1 text-balance">Define a new time-boxed development cycle for a specific promotion.</p>
                </div>
            </div>
        </div>

        <!-- Form Body -->
        <form action="/sprints/store" method="POST" class="p-8 space-y-8" onsubmit="return false;">
            
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Order Attribute (Numeric) -->
                <div class="space-y-2">
                    <label for="order" class="block text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] ml-1">Sprint Order</label>
                    <input type="number" id="order" name="order" placeholder="e.g. 1" min="1"
                ...
                <div class="md:col-span-2 space-y-2">
                    ...
                    <input type="text" id="name" name="name" placeholder="e.g. PHP Fundamentals & SQL" 
            ...
            <div class="space-y-2">
                ...
                <div class="relative group">
                    <select id="class_id" name="class_id" class="block w-full px-5 py-4 bg-slate-900 border border-slate-700 rounded-2xl text-white text-sm focus:ring-2 focus:ring-indigo-600 outline-none transition-all appearance-none cursor-pointer">
                        <option value="" disabled selected>Select the class for this sprint...</option>
                        <option value="1">Fullstack Web Development 2025</option>
                        <option value="2">UI/UX Design Masterclass 2024</option>
                        <option value="3">Data Science Batch Alpha</option>
                    </select>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <!-- Start Date -->
                <div class="space-y-2">
                    <label for="start_date" class="block text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] ml-1 text-emerald-500/80">Start Date</label>
                    <input type="date" id="start_date" name="start_date" 
                        class="block w-full px-5 py-4 bg-slate-900 border border-slate-700 rounded-2xl text-white focus:ring-2 focus:ring-emerald-600 outline-none transition-all text-sm">
                </div>

                <!-- End Date -->
                <div class="space-y-2">
                    <label for="end_date" class="block text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] ml-1 text-red-500/80">End Date</label>
                    <input type="date" id="end_date" name="end_date" 
                        class="block w-full px-5 py-4 bg-slate-900 border border-slate-700 rounded-2xl text-white focus:ring-2 focus:ring-red-600 outline-none transition-all text-sm">
                </div>
            </div>
